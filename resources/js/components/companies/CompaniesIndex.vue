        ...
        <div class="flex place-content-end mb-4">
            ...
            >
                <router-link
                    ...
                    >Create Business</router-link
                >
            </div>
            <!-- px-4 py-2 text-white bg-green-600 hover:bg-green-700 cursor-pointer -->
            <div class="">
                <!-- <router-link
                    :to="{ name: 'companies.create' }"
                    class="text-sm font-medium"
...
export default {
    methods: {
        download() {
            ...
            const { getCompaniesExport } =  useCompanies();
            //     await getCompaniesExports();
            // console.log("test");
        },
    },
    setup() {
